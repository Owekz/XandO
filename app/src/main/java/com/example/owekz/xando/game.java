...
class AnimatedButton {
    ...
    public void setImage() {
        if ((turn % 2) == 0) {
            switch (stage) {
                case 0:
                    button.setImageResource(R.drawable.x0);
                    break;
                case 1:
                    button.setImageResource(R.drawable.x1);
                    break;
                case 2:
                    button.setImageResource(R.drawable.x2);
                    break;
                case 3:
                    button.setImageResource(R.drawable.x3);
                    break;
                case 4:
                    button.setImageResource(R.drawable.x4);
                    break;
                case 5:
                    button.setImageResource(R.drawable.x5);
                    break;
                case 6:
                    button.setImageResource(R.drawable.x6);
                    break;
                case 7:
            ...
            switch (stage) {
                case 0:
                    button.setImageResource(R.drawable.o0);
                    break;
                case 1:
                    button.setImageResource(R.drawable.o1);
                    break;
                case 2:
                    button.setImageResource(R.drawable.o2);
                    break;
                case 3:
                    button.setImageResource(R.drawable.o3);
                    break;
                case 4:
                    button.setImageResource(R.drawable.o4);
                    break;
                case 5:
                    button.setImageResource(R.drawable.o5);
                    break;
                case 6:
                    button.setImageResource(R.drawable.o6);
                    break;
                case 7:
...
public class game extends Activity {
    ...
    public void finishGame(Outcome out, int call_no, String p1_name, String p2_name) {
		...
		/* new status */
        final TextView status2 = findViewById(R.id.TextView01);
        ...
        if (call_no == 1) {
            ...
            final ImageView img = findViewById(R.id.ImageView01);
            AnimationDrawable ad = (AnimationDrawable) getBaseContext().getResources()
                    .getDrawable(R.drawable.amin);
    ...
    public boolean canWin(int index, Cell player) {
        ...
        can = !((out == Outcome.NONE) || (out == Outcome.CAT));
